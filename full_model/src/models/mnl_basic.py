...
def create_mnl_basic(database: db.Database):
    ...
    # Parameters with appropriate bounds and starting values
    # Bounds enforce economically sensible constraints:
    # - ASC: typically [-10, 10] for alternative-specific constants
    # - B_FEE: negative (cost disutility), bounded [-10, 0]
    # - B_DUR: negative (duration disutility), bounded [-5, 0]
